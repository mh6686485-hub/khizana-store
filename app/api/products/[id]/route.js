...
export async function PUT(req, { params }) {
  ...
  try {
    ...
    const { rows } = await p.query(
      `UPDATE products SET code=$1,name=$2,category=$3,price=$4,original_price=$5,description=$6,specs=$7,image=$8,status=$9,is_new=$10,is_best_seller=$11,offer_expiry=$12,stock=$13,min_stock=$14,images=$15 WHERE id=$16 RETURNING *`,
      [
